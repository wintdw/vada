    ...
    async with get_mysql_connection() as connection:
        async with get_mysql_cursor(connection) as cursor:
            ...
            await cursor.execute(
                "INSERT INTO `CrawlInfo` (crawl_id, index_name, access_token, refresh_token, crawl_interval) VALUES (%s, %s, %s, %s, %s)", (crawl_info.crawl_id, crawl_info.index_name, crawl_info.access_token, crawl_info.refresh_token, crawl_info.crawl_interval)
            )
