...
async def ingest_partner_nhanh_platform_callback(accessCode: str, state: str):
...
async def ingest_partner_nhanh_platform_auth(vada_uid: str):
    return RedirectResponse(url=f"https://nhanh.vn/oauth?version=2.0&appId=75154&state={vada_uid}&returnLink={settings.NHANH_REDIRECT_URI}")
